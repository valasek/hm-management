<template>
  <div class="w-1/3 bg-red rounded-lg border-solid border-2 border-gray-600">
    <div>
      <div
    ...
    <div>
      ...
      <div class="mx-4 my-4">
        <div class="my-2">
          ...
          <div class="inline-block">7.12.2020</div>
        </div>
        <div>
          <div class="inline-block">
            <svg
          ...
          <div class="inline-block">7.12.2022</div>
        </div>
      </div>
    </div>
    <div>
      ...
      <div class="mx-4 my-4">
        <div class="my-2">
          ...
          <div class="inline-block">Mobilní telefon</div>
        </div>
        <div class="my-2">
          <div class="inline-block">
            <svg
          ...
          <div class="inline-block">moto e7</div>
        </div>
        <div>
          <div class="inline-block">
            <svg
          ...
          <div class="inline-block">ydmt10912m1p</div>
        </div>
      </div>
    </div>
    <div>
      ...
      <div class="mx-4 my-4">
        <div class="my-2">
          ...
          <div class="inline-block">Notebook #000254, Dell</div>
        </div>
      </div>
    </div>
  </div>
